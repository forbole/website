  ...
  return (
    <Layout title={t('page_title')} navLink="/products" footer>
      ...
      >
        ...
        <HeaderCard title={t('title')} desc_1st={t('desc')}  head_bg={isMobile?'/staking_service/head_bg_m@2x.png':'/staking_service/head_bg@2x.png'}/>
          ...
          <Grid container spacing={theme.spacing(2)}>
            <Grid item laptop={4} mobile={12}>
              <IntroPanel
                ...
                imageHref={isMobile?require("/public/staking_service/mobile_section_3@2x.png"):require("/public/staking_service/desk_section_3@2x.png")}
            ...
            <Grid item laptop={4} mobile={12}>
              <IntroPanel
                ...
                imageHref={isMobile?require("/public/staking_service/mobile_section_1@2x.png"):require("/public/staking_service/desk_section_1@2x.png")}
            ...
            <Grid item laptop={4} mobile={12}>
              <IntroPanel
                ...
                imageHref={isMobile?require("/public/staking_service/mobile_section_2@2x.png"):require("/public/staking_service/desk_section_2@2x.png")}
