          ...
          <Grid container spacing={theme.spacing(2)}>
            <Grid item laptop={4} mobile={12}>
              <IntroCard
                ...
                list={[
                  t('ETH_Staking_by_Forbole_item_1'),
                  t('ETH_Staking_by_Forbole_item_2'),
                ]}
            ...
            <Grid item laptop={4} mobile={12}>
              <IntroCard
                ...
                list={[
                  t('New_Chains_on_boarded_item_1'),
                  t('New_Chains_on_boarded_item_2'),
                  t('New_Chains_on_boarded_item_3'),
                ]}
            ...
            <Grid item laptop={4} mobile={12}>
              <IntroCard
                ...
                btnClick={() =>
                  router.push(
                    'https://www.eventbrite.hk/e/-aug-22-29-tickets-686420260477'
                  )
                }
              ></IntroCard>
            </Grid>
