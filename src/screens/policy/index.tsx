...
import * as tcStyles from "../terms_and_conditions/styles.module.scss";
          ...
          <div className={styles.content}>
            <div className={tcStyles.wrapper}>
              <div className={styles.tnc}>
                <h2 className={styles.contentTitle}>{t("title")}</h2>
                <span className={styles.updatedDate}>{t("updatedDate")}</span>
                <Trans
                  components={[
                  ...
                  ns="policy"
                />
                <span className={styles.description2}>{t("description2")}</span>
                ...
                >
                  <span className={styles.c2}>
                    ...
                    as your social media account that you disclose to us or your
                    blockchain wallet or blockchain profile you connect to the
                    Services;
                  </span>
                </p>
                <p
                ...
                >
                  <span className={styles.c2}>
                    ...
                    such as any posts or comments you publish on our Platform or
                    our Services;{" "}
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                ...
                >
                  <span className={styles.c2}>
                    ...
                    online activities and actions on the Platform, such as your
                    usage data, navigation path, frequency of visit and length
                    of access to the Platform, whether you are returning or new
                    user; and
                  </span>
                </p>
                <p
                ...
                >
                  <span className={styles.c2}>
                    <span className="t1">(iii)</span> information about your web
                    traffic, settings or preferences collected via cookies (text
                    files that websites store on a visitor’s device to uniquely
                    identify the visitor’s browser or store information),
                    browser web storage or locally stored objects, web beacons
                ...
                <p className={styles.c4}>
                  <span className={styles.c2}>
                    <span className="t1">2.4</span> We do not collect sensitive
                    data or special category data about you. This includes
                    details about your race, ethnic origin, politics, religion,
                    trade union membership, genetics, biometrics, health, or
                    sexual orientation.
                  </span>
                </p>
                <p className={[styles.c10, styles.c4].join(" ")}>
                ...
                <p className={styles.c4}>
                  <span className={styles.c2}>
                    <span className="t1">2.5</span> We do not knowingly collect
                    or use personal data from minors.
                  </span>
                </p>
                <p className={styles.c3}>
                  <span className={styles.c2} />
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(a)</span> to operate the Services and
                    our business;
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(b)</span> to maintain and improve our
                    Services or certain functionalities or features of our
                    Services;
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(c)</span> to process your transactions
                    or your interactions with various blockchain networks and
                    protocols;
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    ...
                    security alerts, and system administrative information; and
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                  <span className={styles.c2} />
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(e)</span> to provide support when you
                    use our Services, such as responding to your requests and
                    enquiries.
                  </span>
                </p>
                <p className={[styles.c10, styles.c4].join(" ")}>
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    ...
                    review user behaviour anonymously or on an aggregated basis,
                    and to develop and evaluate new products or features;
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                  <span className={styles.c2} />
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(e)</span> to enforce the Terms of Use
                    that govern the use of the Platform and the Services.{" "}
                  </span>
                </p>
                <p className={styles.c3}>
                  <span className={styles.c2} />
                ...
                <p className={styles.c4}>
                  <span className={styles.c2}>
                    <span className="t1">4.1</span> We do not sell your personal
                    information.
                  </span>
                </p>
                <p className={[styles.c10, styles.c4].join(" ")}>
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(b)</span> service providers (including
                    companies and individuals) that help us operate the
                    Services, such as web traffic tracking, analytics, storage,
                    communication or payment solutions;
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                  <span className={styles.c2} />
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    ...
                    including lawyers, attorneys, auditors, bankers and insurers
                    where necessary;
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(e)</span> parties that acquire control
                    over all or any substantial portion of the business or
                    assets of Forbole, such as in a business merger, acquisition
                    or reorganisation or transactions with similar nature; and{" "}
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                  <span className={styles.c2} />
                ...
                <p className={styles.c1}>
                  <span className={styles.c2}>
                    <span className="t1">(f)</span> third party platforms where
                    you have enabled features or functionality that connect the
                    Services with any third party’s services, in which case you
                    must review the terms and conditions and privacy policy of
                    such third party.
                  </span>
                </p>
                <p className={[styles.c1, styles.c10].join(" ")}>
                ...
                >
                  <span className="t1">5.1</span> You may update or correct any
                  personal information we hold in our systems anytime by
                ...
                >
                  <span className={styles.c2}>
                    ...
                    completion of on-chain transaction) or administrative (such
                    as announcement related to security breaches or
                    cyberattacks).
                  </span>
                </p>
                <p
                ...
                >
                  <span className={styles.c2}>
                    <span className="t1">5.3</span> You may opt out from online
                    tracking, such as blocking cookies in your browser by
                    following instructions in your browser settings, or
                ...
                >
                  <span className={styles.c2}>
                    <span className="t1">5.4</span> If you have given us consent
                    to use your personal information for a specific purpose, you
                    may withdraw your consent anytime by contacting us at
                    privacy@forbole.com .
                  </span>
                </p>
                <p
                ...
                >
                  <span className={styles.c2}>
                    <span className="t1">5.5</span> If you have any questions or
                    feedback regarding how we address your requests concerning
                    your personal data, please contact us at privacy@forbole.com
                    .
                  </span>
                </p>
                <p className={styles.c12}>
                ...
                >
                  <span>
                    <span className="t1">6.1</span> Our Platform includes links
                    to third-party websites, such as the websites of various
                    blockchain networks or crypto projects. If you access any of
                    these third-party websites, you will be doing so at your own
                    risk. We do not control any third-party websites, or any
                    products or services offered by third parties and we are not
                    responsible for their actions or omissions in privacy
                    practices.
                  </span>
                </p>
                <p className={styles.c12}>
                ...
                >
                  <span className={styles.c2}>
                    ...
                    for which your personal information is collected, including
                    for the purposes of fulfilling any legal, accounting or
                ...
                <p className={styles.c12}>
                  <span className="c8" style={{ fontWeight: 700 }}>
                    <span className="t1">8.</span> Security and transfer of your
                    personal data
                  </span>
                </p>
                <p
                ...
                >
                  <span className={styles.c2}>
                    ...
                    security of the personal information we collect. However, we
                    are unable to guarantee the security of your personal
                    information.
                  </span>
                </p>
                <p
                ...
                >
                  <span className={styles.c2}>
                    ...
                    and the parties with whom we share your personal information
                    may operate in a country outside your country of residence.
                  </span>
                </p>
                <p
                  className="c7"
                ...
                >
                  <span className={styles.c2}>
                    ...
                    protection laws that are equivalent to those in your country
                    of residence. When we share information with these parties,
                    we use our best endeavours (such as by entering into
                    contractual terms) to safeguard the security of the
