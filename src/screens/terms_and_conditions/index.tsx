          ...
          >
            <TNCCSS>
              ...
              >
                ...
                <p>
                  <span className="t1">5.1</span>Our Services, together with the
                ...
                <p>
                  <span className="t1">5.2</span>Forbole makes&nbsp;
                ...
                <p className="li">
                  <span className="t2">(a)</span>the Services complies with any
                  obligations that the users may have under any applicable laws,
                  rules or regulations; or
                </p>

                <p className="li">
                  <span className="t2">(b)</span>the Services will always be
                  available.
                </p>
