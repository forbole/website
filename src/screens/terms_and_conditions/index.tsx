...
const TermsAndConditions = () => {
  ...
  useEffect(()=>{
   ( document.querySelectorAll('.t1')as NodeListOf<HTMLElement>).forEach(function(d ){
      if(!d.parentElement)return
      const h=d.parentElement.offsetHeight-1
      d.style.height=h+'px';
    });
   (document.querySelectorAll('.t2')as NodeListOf<HTMLElement>).forEach(function(d ){
      if(!d.parentElement)return
      const h=d.parentElement.offsetHeight-1
      d.style.height=h+'px';
    })
      ...
      <Box
        ref={topRef}
         sx={{
          ...
          padding:"100px",
          borderRadius: '24px',
          background: 'linear-gradient(179deg, #FFF 0%, rgba(255, 255, 255, 0.64) 50%)',
          boxShadow: '0px 14px 64px -4px rgba(2, 38, 225, 0.12), 0px 8px 22px -6px rgba(2, 38, 225, 0.12)',
        ...
        >
          <TNCCSS>
            ...
            >
              ...
              <p>
                The Forbole Platform is operated by Forbole Technology Limited, a company
                incorporated in Hong Kong with company registration number
                3282304, having its registered office at 7/F,Cheung Hing Industrial Building, 12P Smithfield, Kennedy Town,
                 Hong Kong (&ldquo;<b>Forbole</b>&rdquo;,
              ...
              <p>
                <span className="t1">1</span><b>Our Platform</b>
              </p>
              ...
              <p className="li"><span className="t2">(a)</span>our staking services (please
                refer to&nbsp;
                <a
                  href=""
                  style={{ textDecoration: 'underline' }}
              ...
              <p className="li"><span className="t2">(b)</span>Big Dipper, our block explorer
              ...
              <p className="li"><span className="t2">(c)</span>Forbole Ventures, private
              ...
              <p>
                <span className="t1">2.1</span>All intellectual property rights
                subsisting in our Platform (including our applications, source
                code, software, content, text, graphics, images, logos, audio or visual
                files and other materials, offered from time to time, and all
                improvements, enhancements, modifications, updates thereof from time to
              ...
              <p className="li"><span className="t2">(a)</span>as expressly permitted by these
                Terms; or
              </p>

              <p className="li"><span className="t2">(b)</span>with our prior written approval.
              </p>
              ...
              <p className="li"><span className="t2">(a)</span>is for the sole purpose of
                enabling you to use and enjoy the benefit of our Platform as
                offered by us and in such manner as permitted by these Terms;
                and
              </p>

              <p className="li"><span className="t2">(b)</span>will be revoked and terminated if
              ...
              <p>
                ...
                Proprietary Materials is strictly prohibited unless with our prior written
                approval.
              </p>
              ...
              <p>
                ...
                (Version 2.0, January 2004).Your attention is drawn to Clause 4 of the Apache Licence
                which requires any person reproducing or distributing our work (for example when you
                fork Big Dipper) to include attribution notices contained in the "NOTICE" text file.
              </p>

              <p>
                <span className="t1">2.6</span>Our brand names and trade names,
              ...
              <p>
                <span className="t1">3.</span><b>Disclaimers</b>
              </p>
              ...
              <p>
                ...
                implied, whether on functionality, availability, security or otherwise) about the Platform and any products or services we
                provide.
              </p>
              ...
              <p>
                <span className="t1">3.7</span>No warranties or representations
              ...
              <p>
                <span className="t1">4.</span><b>Acceptable Use Policy</b>
              </p>

              <p>
                <span className="t1">4.1</span>As part of these Terms, you agree
              ...
              <p className="li"><span className="t2">(a)</span>use our Platform for any unlawful
                or unauthorised purposes;
              </p>

              <p className="li"><span className="t2">(b)</span>use our Platform to engage in any
              ...
              <p className="li"><span className="t2">(c)</span>sell, re-sell or attempt to
                benefit in a commercial fashion from any data, content or
                information available on the Platform;
              </p>

              <p className="li"><span className="t2">(d)</span>probe, scan, or test the
                vulnerability of any system or network;
              </p>

              <p className="li"><span className="t2">(e)</span>breach or otherwise circumvent
                any security or authentication measures or service usage limits;
              </p>

              <p className="li"><span className="t2">(f)</span>access, tamper with, or use
                non-public areas or parts of the Platform;
              </p>

              <p className="li"><span className="t2">(g)</span>interfere with or disrupt any
              ...
              <p className="li"><span className="t2">(h)</span>reverse engineer, decompile,
              ...
              <p className="li"><span className="t2">(i)</span>copy, translate, make adaptations
                of our Platform or any of its content without authorisation;
              </p>

              <p className="li"><span className="t2">(j)</span>send unsolicited communications,
                promotions or advertisements, or spam;
              </p>

              <p className="li"><span className="t2">(k)</span>take any action that overloads or
                disrupts the integrity of infrastructure of our Platform or any
                of our features or functions;
              </p>

              <p className="li"><span className="t2">(l)</span>spoof, phish, pharm, pretext,
              ...
              <p className="li"><span className="t2">(m)</span>post, publish, upload, display,
              ...
              <p className="li"><span className="t2">(n)</span>violate or infringe upon our
                intellectual property rights or the intellectual property rights
                of others,
              </p>

              <p className="li"><span className="t2">(o)</span>violate the letter or spirit of
              ...
              <p className="li"><span className="t2">(a)</span>the Platform complies with any
                obligations that the users may have under any applicable laws,
                rules or regulations; or
              </p>

              <p className="li"><span className="t2">(b)</span>the Platform will always be
                available.
              </p>
              ...
              <p className="li"><span className="t2">(a)</span>any error or interruption in
                usage or any loss, inaccuracy or corruption of data, nor any
                cost of procurement of substitute goods, services or technology;
              </p>

              <p className="li"><span className="t2">(b)</span>any damages, losses, claims
              ...
              <p className="li"><span className="t2">(c)</span>any damages or losses arising out
              ...
              <p className="li"><span className="t2">(d)</span>any other matters beyond the
              ...
              <p>
                <span className="t1">6.</span><b>Termination and Withdrawal</b>
              </p>

              <p>
                <span className="t1">6.1</span>These Terms are effective unless
              ...
              <p className="li"><span className="t2">(a)</span>you are in serious or repeated
                breach of these Terms;
              </p>

              <p className="li"><span className="t2">(b)</span>you are using the Platform in a
                manner that would cause a real risk of harm or loss to us, other
                users, or the public;
              </p>

              <p className="li"><span className="t2">(c)</span>we are requested to do so by
                government or regulatory authorities or as required under
                applicable laws, regulations or legal processes; or
              </p>

              <p className="li"><span className="t2">(d)</span>our provision of the Platform to
              ...
              <p>
                <span className="t1">7.</span><b>Force majeure</b>
              </p>

              <p>
                <span className="t1">7.1</span>Neither Party will be in
              ...
              <p>
                <span className="t1">7.2</span>A force majeure event
              ...
              <p>
                <span className="t1">8.</span><b>General Provisions</b>
              </p>

              <p>
                <span className="t1">8.1</span>Forbole may modify these
              ...
              <p>
                <span className="t1">8.2</span>These Terms&nbsp;constitute
              ...
              <p>
                <span className="t1">8.3</span>If any provision of these
              ...
              <p>
                <span className="t1">8.4</span>The failure of either Party
              ...
              <p>
                <span className="t1">8.5</span>A reference to a "person" includes
              ...
              <p>
                <span className="t1">8.6</span>Clause and schedule headings are
                for convenience only and do not affect the interpretation of the
                provisions of this Agreement.
              </p>
              <p>
              <span className="t1">9</span><b>Governing Law</b>
              </p>
              <p className="li">
              ...
              <p>
                <span className="t1">10</span><b>Dispute Resolution</b>
              </p>
              <p>
              ...
              <p ><span className="t2">(A)</span>A number of blockchain networks
              ...
              <p ><span className="t2">(B)</span>Forbole has developed knowledge,
              ...
              <p ><span className="t2">(C)</span>Incidental to validating and
              ...
              <p ><span className="t2">(D)</span>The non-custodial staking
              ...
              <p>
                <span className="t1">11.</span><b>Delegation and Staking</b>
              </p>

              <p>
                <span className="t1">11.1</span>On and subject to the protocols
                of the Supported Networks and these Terms, you may:
              </p>

              <p className="li"><span className="t2">(a)</span>delegate any whole or fractional
                number of digital blockchain assets (<b>&ldquo;Tokens&rdquo;</b>
                ) of a Supported Network to Forbole at any time; and
              </p>

              <p className="li"><span className="t2">(b)</span>(subject to unbonding and any
                other applicable requirements) withdraw any number of Tokens
                from delegation at any time.
              </p>

              <p>
                <span className="t1">11.2</span>On and subject to the protocols
                of the Supported Networks and these Terms, we: &nbsp;
              </p>

              <p className="li"><span className="t2">(a)</span>exercise the rights of the
              ...
              <p className="li"><span className="t2">(b)</span>exercise the rights of the
              ...
              <p className="li">(the Validation Rights and the Voting Rights collectively, the
              ...
              <p>
                <span className="t1">11.5</span>For the avoidance of doubt, your
                delegation of Tokens as contemplated under these Terms:
              </p>

              <p className="li"><span className="t2">(a)</span>does not represent or constitute
                any loan or any contribution of capital to, or other investment
                in, Forbole or its securities;
              </p>

              <p className="li"><span className="t2">(b)</span>does not create or imply any
                partnership, agency or fiduciary relationship between you and
                Forbole.
              </p>

              <p>
                <span className="t1">11.6</span>Our Services are non-custodial and purely technological
                in nature. Our offer of Services does not constitute the
                offering of any financial services or financial advice to
                anyone.We do not take any ownership of your Tokens or digital assets. You remain fully
                responsible for all choices you make on delegation of your Tokens or any other
                arrangements concerning your digital assets.
              </p>
              ...
              <p>
                <span className="t1">12.</span><b>Rewards</b>
              </p>
              ...
              <p className="li"><span className="t2">(a)</span>to your wallet address from which
                you have delegated Tokens to Forbole, or if you so specified,
                another wallet address of your choice; and
              </p>

              <p className="li"><span className="t2">(b)</span>to Forbole as a service fee for
                providing the Services.
              </p>

              <p>
                <span className="t1">12.2</span>It is important to note that no
              ...
              <p>
                <span className="t1">12.4</span>As all Rewards are generated and
              ...
              <p>
                <span className="t1">12.6</span>The rate of our service fee for
              ...
              <p>
                <span className="t1">12.7</span>Any portion of Rewards or other
              ...
              <p>
                <span className="t1">12.9</span>For the purposes of these Terms,
              ...
              <p>
                <span className="t1">13.1</span>From time to time the protocols
              ...
              <p className="li"><span className="t2">(a)</span>Forbole has sole and absolute
                discretion in determining actions in response to protocol
                changes, airdrops and forks;
              </p>

              <p className="li"><span className="t2">(b)</span>our exercise (or non-exercise) of
              ...
              <p className="li"><span className="t2">(c)</span>Forbole is not responsible for
              ...
              <p className="li"><span className="t2">(a)</span> notify you of pending,
                threatened or actual forks; nor
              </p>

              <p className="li"><span className="t2">(b)</span>respond to forks in ways that
                benefit you over Forbole itself.
              </p>

              <p>
                <span className="t1">14.</span><b>Conditions Precedent</b>
              </p>
              ...
              <p>
                <span className="t1">14.2</span>Our offer of our Services to you
              ...
              <p className="li"><span className="t2">(a)</span>your representations and
                warranties under Clauses 15.1 and 15.2 are and remain true,
                accurate and complete;
              </p>

              <p className="li"><span className="t2">(b)</span>the nodes operated by us are and
                remain in the active set of such Supported Network;
              </p>

              <p className="li"><span className="t2">(c)</span>the performance of these Terms by
                us does not require any licences, permits or registrations
                (under securities laws or otherwise) not possessed by us;
              </p>

              <p className="li"><span className="t2">(d)</span>the performance of these Terms by
              ...
              <p className="li"><span className="t2">(e)</span>the performance of these Terms by
                either Party does not constitute any breach, default or
              ...
              <p className="li"><span className="t2">(a)</span>where one or more Tokens you
              ...
              <p className="li"><span className="t2">(b)</span>where you become an entity or
              ...
              <p className="li"><span className="t2">(c)</span>where we are deemed to have a
              ...
              <p className="li"><span className="t2">(a)</span>(if a Party is an individual) the
                Party is of legal age in its jurisdiction of residence;
              </p>

              <p className="li"><span className="t2">(b)</span>(if a Party is a business entity,
              ...
              <p className="li"><span className="t2">(c)</span>the Party has all requisite
              ...
              <p className="li"><span className="t2">(a)</span>you have full right, title and
                interest in and to the Tokens delegated to us;
              </p>

              <p className="li"><span className="t2">(b)</span>you are experienced and
              ...
              <p className="li"><span className="t2">(c)</span>you are not (as an entity or
                individual) located, organised or ordinarily resident in a
                sanctioned jurisdiction (currently,&nbsp;Cuba, Iran, North
                Korea, Russia, Syria and Crimea, Donetsk and Luhansk of
              ...
              <p className="li"><span className="t2">(d)</span>you are not on the Specially
              ...
              <p className="li"><span className="t2">(e)</span>you have not been convicted of
              ...
              <p className="li"><span className="t2">(f)</span>the Tokens delegated to us are
              ...
              <p>
                <span className="t1">17.1</span>These Terms come into effect and
              ...
              <p className="li"><span className="t2">(a)</span>in case of the delegator, by
                withdrawing your Tokens from delegation; or
              </p>

              <p className="li"><span className="t2">(b)</span>in case of Forbole, by
              ...
              <p>
                <span className="t1">17.6</span>Termination of these Terms will
              ...
              <p>
              <span className="t1">18</span><b>Big Dipper</b>
              </p>
              ...
              <p>
              <span className="t1">19</span><b>Forbole Ventures</b>
              </p>

              <p>
                <span className="t1">19.1</span>Forbole Ventures is a private
                investment arm of the Forbole Group. Forbole Ventures performs asset
                management and investment advisory activities solely for fellow
                group companies within the Forbole Group.
              </p>

              <p>
                <span className="t1">19.2</span>Forbole Ventures does not offer
              ...
              <p>
                <span className="t1">19.3</span>The Forbole Ventures website and
