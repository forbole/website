          ...
          <Box
            sx={{
              [theme.breakpoints.up('mobile')]: {
                width: '100%',
                background: staking
                  ? 'url(/staking/images/assets/footer_mobile_val.png)'
                  : 'url(/staking/images/assets/footer_mobile.png)',
              ...
              [theme.breakpoints.up('laptop')]: {
                width: '100%',
                background: staking
                  ? 'url(/staking/images/assets/footer_desktop_val.png) bottom'
                  : 'url(/staking/images/assets/footer_desktop2.svg) bottom',
